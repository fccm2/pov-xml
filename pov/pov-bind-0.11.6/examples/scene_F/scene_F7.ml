...
let box_color2 = PovColor.RGB(0.1, 1.0, 0.1)  (* green *)
...
let () =
  ...
  for i = 0 to pred 22 do
    let x = (float (rand_num 16 32)) /. 10.0 in
    let y = 0.0 in
    let z = (float (rand_num 10 18)) /. 10.0 in
