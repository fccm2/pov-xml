...
let () =
  ...
  let texture = Pov.new_texture ~color:box_color0 () in
  let sc = Pov.add_box sc
    ~corner1:(0.0, 0.2, 0.2)
    ~corner2:(0.2, 0.0, 0.0)
    ~translate:( 1.8, 0.0,  0.6)
    ~scale:(_scale 0.4)
    ~texture ()
  in
